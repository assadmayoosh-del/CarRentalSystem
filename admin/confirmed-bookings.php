...
<head>
	...
	<title>ProModel Car Rental | Confirmed Bookings</title>
...
<body>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									?>	
										<tr>
											...
											<td>
												<!-- ✅ التعديل هنا: خلّينا الرابط عادي بس أضفنا كلاس -->
												<a href="bookig-details.php?bid=<?php echo htmlentities($result->id);?>" class="view-booking">View</a>
											</td>
										</tr>
									<?php $cnt=$cnt+1; } } ?>
	...
	<script>
	$(document).on('click', 'a.view-booking', function(e){
		e.preventDefault();
