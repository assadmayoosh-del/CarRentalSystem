...
if(isset($_GET['del']))
{
  ...
  // نخلي الرسالة للبوب (SweetAlert) بدل succWrap
...
<head>
	...
	<title>ProModel Car Rental |Admin Manage Brands</title>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<!-- ❌ شلنا succWrap/errorWrap من هون عشان ما تظهر فوق مع البوب -->
								<!-- إذا بدك تخلي ERROR فقط ممكن نرجعه -->
									...
									?>	
										<tr>
											...
											<td>
												...
												<!-- ✅ بدل confirm() -->
												<a href="#" class="delete-brand" data-id="<?php echo $result->id;?>">
