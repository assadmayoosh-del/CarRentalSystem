...
<head>
  ...
  <title>ProModel Car Rental | Admin Manage Vehicles</title>
        ...
        <div class="col-md-12">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <!-- نخفي رسائل ال div القديمة عشان ما تضل تظهر تحت -->
              <!--
...
?>
                  <tr>
                    ...
                    <td>
                      <a href="edit-vehicle.php?id=<?php echo (int)$result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;

                      <!-- بدل confirm -->
                      <a href="#" onclick="confirmDelete(<?php echo (int)$result->id;?>); return false;">
...
function confirmDelete(id){
  Swal.fire({
    ...
    if (result.isConfirmed) {
      window.location.href = 'manage-vehicles.php?del=' + id;
    }
  });
}
</script>
