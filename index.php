...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>
        At ProModel Car Rental, we offer a modern and reliable car rental platform that allows users to easily browse, select, and rent vehicles based on their needs.
        Our system provides detailed car information, transparent pricing, and a smooth booking process,
        ensuring a convenient and efficient rental experience for all customers.
      </p>
    </div>
...
<!-- Fun Facts (معدل: أرقام أقل + أبطأ + نفس التصميم) -->
...
(function () {
  ...
  function startCounters() {
    ...
    var section = document.querySelector(".fun-facts-section");
    if (!section) return;

    var sectionTop = section.getBoundingClientRect().top;
    var windowH = window.innerHeight || document.documentElement.clientHeight;

    // يبدأ قبل ما ندخل القسم شوي
    if (sectionTop <= windowH - 120) {
      started = true;
